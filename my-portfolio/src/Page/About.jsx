      ...
      <div className='relative mx-auto flex w-11/12 h-[100%] max-w-maxContent flex-col items-center justify-center gap-8 mt-10'>
        ...
        <div className="flex w-full flex-col md:flex-row gap-x-20 gap-y-4 items-center justify-center">
          ...
          className="relative">
            <img 
            src={profilePic}
             className='relative rounded-md mt-8 ml-3  p-[2px] z-10' width={325} alt='author pic' loading='lazy'/>
          ...
          transition={{duration:1, ease: [0.45, 0, 0.55, 1]}}
           className="w-full md:w-[37%] flex gap-2 flex-col">
            ...
            <h2 className='subHeading'>I'm Siddharth, a Java Full Stack and MERN Stack Web Developer.</h2>
            <p className='paragraph'>
            Hey there, I'm Siddharha Bharali—an avid Web Developer with a knack for crafting elegant, user-friendly websites. I'm also your go-to guy for backend using java with springboot. Let's turn your ideas into digital masterpieces!
            </p>
            <p className='paragraph font-semibold'>Contact</p>
            <p className='paragraph'>
              If you'd like to say hi or get started with your project and need my help, feel free to contact me at <strong> <a href="mailto:siddharthabharaliassam@gmail.com">siddharthabharaliassam@gmail.com</a></strong>.
            </p>
