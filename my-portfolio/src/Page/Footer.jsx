...
const socialLinks = [
  {
    icon: "AiFillLinkedin",
    heading: "Linkedin",
    link: "https://www.linkedin.com/in/siddhartha-bharali-95642521a",
    
  },
  {
    icon: "BsGithub",
    heading: "Github",
    link: "https://github.com/Sidd444",
      ...
      <div className='w-full flex flex-col gap-y-4 sm:flex-row justify-center items-center px-8 mt-4'>
        ...
        transition={{duration:1, ease: [0.45, 0, 0.55, 1]}}
         className='flex item-center  sm:w-[50%]'>
            ...
            <p className='text-lg  font-bold text-gray-300'>Siddhartha Bharali</p>
        </m.div>
        {/* Social Icons */}
        <m.div 
        initial={{x:0, opacity:0}}
