    ...
    <section className='w-full md:h-screen z-0  snap-start mt-14 pt-14 ' id='skill'>
      ...
      transition={{duration:1, ease: [0.45, 0, 0.55, 1]}}
       className=' w-8/12 mx-auto flex flex-col justify-center items-center gap-3 mt-12 '>
           ...
           <p className='paragraph text-center'>Currently I am working as a mentor at UpskillMafia where I am tasked with managing group for hackathon and checking assignments realated to MERN.<br/>I'm a Software developer with a knack for crafting dynamic web applications. <br/> Proficient in Java, HTML, CSS, and JavaScript, I specialize in SpringBoot, React, Express and Tailwind for building engaging web applications and use MySql or MongoDB Atlas for Database. Let's bring your projects to life!</p>
